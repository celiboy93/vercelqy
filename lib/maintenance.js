...
async function setLink(url, data) {
  const key = "link:" + Buffer.from(url).toString("base64url");
...
module.exports = { getAllLinks, setLink, deleteLink, runMaintenance };
